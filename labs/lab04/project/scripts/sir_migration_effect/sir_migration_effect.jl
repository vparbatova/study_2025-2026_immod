...
migration_rates = create_migration_matrix(p[:C],
...
infected_frac(model) = count(a.status == :I for a in
...
println("Результаты сохранены в data/migration_scan_all.csv и
plots/migration_effect.png")
