...
if isfile(param_file)
    ...
    # ===== 1. График: вероятность deadlock от N (классическая модель) =====
    ...
    # ===== 2. График: время до deadlock (только успешные случаи) =====
    ...
    # ===== 3. Сравнение числа едящих в конце =====
    ...
    # ===== 4. Вывод статистики в консоль (ПОЛНОСТЬЮ ИСПРАВЛЕНО) =====
